...
const ModalAddField = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    console.log('Data Field baru:', formData);
    onClose(); 
  };
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-white p-6 rounded-lg shadow-xl w-full max-w-2xl"> 
        <h2 className="text-2xl font-bold text-dark-red underline mb-6">Add Field</h2>
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 gap-x-6 gap-y-4">
            ...
            {/* Kolom 1 */}
            <div>
              <label htmlFor="no_lapang" className="block text-sm font-medium text-gray-700">ID Lapangan</label>
              <input 
                type="text" 
                name="no_lapang" 
                id="no_lapang" 
            ...
            {/* Kolom 3 */}
            <div>
              <label htmlFor="harga" className="block text-sm font-medium text-gray-700">Harga/ Jam</label>
              <input 
                type="number" 
                name="harga" 
                id="harga" 
